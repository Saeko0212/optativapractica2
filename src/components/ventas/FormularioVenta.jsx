              ...
              <Card.Body className="p-0" style={{ maxHeight: "400px", overflowY: "auto" }}>
                {detalles.length === 0 ? (
                  ...
                  <ListGroup variant="flush">
                    {detalles.map((det) => (
                      // CORRECCIÓN 1: id_productos (con 's' al final)
                      <ListGroup.Item key={det.id_productos} className="d-flex justify-content-between align-items-center">
                        <div>
                          <div>{det.nombre}</div>
                        ...
                        <div className="text-end">
                          ...
                          <Button
                            ...
                            size="sm"
                            className="mt-1"
                            // CORRECCIÓN 3: id_productos (con 's' al final)
                            onClick={() => eliminarDetalle(det.id_productos)}
                          >
                            Eliminar
                          </Button>
                        </div>
